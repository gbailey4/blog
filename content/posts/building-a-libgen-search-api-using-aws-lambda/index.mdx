---
title: Building a LibGen Search API using AWS Lambda
date: 2019-06-23
tags:
  - Serverless
  - Ebooks
  - Node
slug: /building-a-libgen-search-api-using-aws-lambda
---
...
1. [ Create Lambda and API Gateway ](#1-create-lambda-and-api-gateway)
2. [ Query LibGen for search term ](https://grahambailey.io#2-querying-libgen)
3. [ Extract IDs from results page ](https://grahambailey.io#3-extract-ids)
4. [ Use IDs to make LibGen API Request ](https://grahambailey.io#4-make-libgen-api-request)
5. [ Do whatever you want with the API response ](https://grahambailey.io#5-use-the-api-response)
